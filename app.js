...
// mongoose.connect("mongodb+srv://lutuf880:JRvHXpbMioYkK2tg@cluster.mongodb.net/Cluster0?retryWrites=true&w=majority")
mongoose.connect("mongodb+srv://lutuf880:JRvHXpbMioYkK2tg%40cluster.mongodb.net/test?retryWrites=true&w=majority")
...
function calculateSavings(costPerUnit, weeklyFrequency, dailyFrequency) {
    // Assuming 4 weeks in a month
    const monthlySavings = costPerUnit * weeklyFrequency * 4;
    const savings3Months = monthlySavings * 3;
    const savings6Months = monthlySavings * 6;
...
// Add this route in your app.js file
app.get("/withdrawal-games", (req, res) => {
    res.render("withdrawal-games");
});

// Add this route at the end of your app.js file
app.get("/savings-calculator", (req, res) => {
    res.render("savings-calculator");
});

// Update the route in your app.js file
app.post("/calculate-savings", (req, res) => {
    const { costPerUnit, weeklyFrequency, dailyFrequency } = req.body;
    const savingsResult = calculateSavings(costPerUnit, weeklyFrequency, dailyFrequency);
    res.render("savings-calculator", { savingsResult });
});
